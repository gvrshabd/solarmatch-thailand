...
The map does not prefetch tiles, scrape tiles, use offline bulk downloading, or hide attribution. If tiles fail, the optional precision step retains keyboard/touch position controls and the required province-level estimate remains available.
