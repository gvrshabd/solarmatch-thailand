  ...
  return (
    <ScreenTransition transitionKey="journey-result" direction="forward" pace="result" className="journey-transition-surface"><main className="results-page">
      ...
      <section className="site-shell result-service-disclaimer" aria-label={english ? 'Service and estimate disclaimer' : 'ข้อจำกัดของบริการและผลประเมิน'}>
        <p><strong>{english ? 'SolarMatch is an information and referral service, not a solar installer.' : 'SolarMatch เป็นบริการให้ข้อมูลและแนะนำผู้ให้บริการ ไม่ใช่บริษัทติดตั้งโซลาร์'}</strong> {english ? 'This result is a preliminary planning estimate—not an engineering design, official quotation or guarantee of savings. Site surveys, quotations and installation agreements are provided directly by independent solar providers. SolarMatch may receive payment for the connection.' : 'ผลลัพธ์นี้เป็นค่าประเมินเบื้องต้นเพื่อการวางแผน ไม่ใช่การออกแบบทางวิศวกรรม ใบเสนอราคาอย่างเป็นทางการ หรือการรับประกันผลประหยัด การสำรวจหน้างาน ใบเสนอราคา และสัญญาติดตั้งจะดำเนินการโดยผู้ให้บริการโซลาร์อิสระโดยตรง และ SolarMatch อาจได้รับค่าตอบแทนจากการเชื่อมโยงดังกล่าว'}</p>
